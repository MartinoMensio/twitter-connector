...
class Tweet(BaseModel):
    ...
    text: str
    retweet: bool
    retweet_source_tweet: Optional[
        ref
    ]  # the ID of the tweet that has been retweeted (retweets with comments instead will have a http://t.co/ link)
    links: List[
        str
    ]  # just to be generic, because someone uses underscores in host name (e.g. https://mkdatahub_public_launch.eventbrite.co.uk)
    user_id: int
